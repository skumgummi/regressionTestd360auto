...
beforeAll(function(){
  ...
  flyer0 = helperFunctions.getFlyer();
  flyer1 = helperFunctions.getFlyer();
  flyer2 = helperFunctions.getFlyer();
  flyer3 = helperFunctions.getFlyer();
...
afterAll(function() {
  ...
  //#1
  it('first adult details', function (){
  ...
  //#2
  it('second adult details', function (){
    var flyer1 = helperFunctions.getFlyer();
    
    
    helperFunctions.scrollElementToBeClickable(passengerPage.firstName1);
    //first name
    passengerPage.firstName1.click();
    passengerPage.firstName1.sendKeys(flyer1.firstName);
    //last name
    passengerPage.lastName1.click();
    passengerPage.lastName1.sendKeys(flyer1.lastName);
    //gender
    passengerPage.gender1.click();
    if (flyer1.gender == 'male'){
