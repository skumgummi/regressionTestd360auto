...
afterAll(function() {
  ...
  it('select return from another city', function(){
    homePage.tripSelect.click();
    homePage.returnFromAnotherCity.click();
  });
  ...
  it('select return origin', function(){
    homePage.openReturnFrom.click();
    homePage.openReturnFrom.sendKeys('DUB');
    homePage.openReturnFrom.sendKeys(protractor.Key.ENTER);
  });
