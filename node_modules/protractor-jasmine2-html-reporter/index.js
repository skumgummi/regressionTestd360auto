...
//custom used for booking stream
var csv = require("fast-csv");
var useCase = 'not defined';
var pnr = 'not acquired';
var passOrFail = 'not determined';
var reportObject = {"use case": useCase, "pnr": pnr, "pass/fail": passOrFail};
var reportArray = [];

var reportObjectExample = {
    "bookingstreams":[
    {"Use case": "1adt2chdSTO_LHR", "pnr": "somePNR", "passed/failed": "passed"},
    {"Use case": "1adt2chd1infSTO_LAX", "pnr": "somePNR", "passed/failed": "passed"},
    {"Use case": "2adt1chd2infSTO_OSL", "pnr": "somePNR", "passed/failed": "passed"},
    {"Use case": "1adtSTO_LHR", "pnr": "somePNR", "passed/failed": "passed"},
    {"Use case": "3adt2chdSTO_LHR", "pnr": "somePNR", "passed/failed": "passed"},
    {"Use case": "2adt2chdSTO_LHR_SEAT", "pnr": "somePNR", "passed/failed": "passed"}
    ]
}
...
function Jasmine2HTMLReporter(options) {
    ...
    self.specDone = function(spec) {
        ...
        if ((self.takeScreenshots && !self.takeScreenshotsOnlyOnFailures) ||
            ...
            var pnrElement = $('span[ng-bind="reservation.airlineBookingReference"]');
            
            pnrElement.isPresent().then(function(pres){
                if (pres){
                    pnrElement.getText().then(function(text){
                        console.log(text+'<------ Is this pnr?!');
                    });
                }
                console.log(pres);
                console.log('checking if pnr is here!!!!!!!');
                console.log('********************************');
            });
        }

        //console.log('**********************');
        //console.log('This is specDone in the reporter!');
        //console.log('**********************');
    };
    self.suiteDone = function(suite) {
        ...
        console.log('**********************');
        console.log('This is suiteDone in the reporter!');
        console.log('**********************');
        //console.log(suite);
    };
    ...
    self.jasmineDone = function() {
        ...
        /*****************************************************************************
        *** This is for creating a csv file, custom for SAS test automation report ***
        ******************************************************************************/
...
function suiteAsHtml(suite) {
        ...
        var jqueryScript = '<script src="https://code.jquery.com/jquery-3.2.1.min.js" integrity="sha256-hwg4gsxgFZhOsEEamdOYGBf13FyQuiTwlAQgxVSNgt4=" crossorigin="anonymous"></script>';

        var html = script + jqueryScript + '<header>';
        html += '<button data-toggle="collapse" data-target="oneTest">Detailed report</button>';
        html += '<div class="oneTest">'; 
...
*/
    function suiteAsHtml(suite) {
        ...
        html += jqueryScript + script + '<header>';
        ...
        html += '<li>Skipped: <strong>' + suite._skipped + '</strong></li>';
        html += '<li>Failures: <strong>' + suite._failures + '</strong></li>';
        html += '<li><button data-toggle="collapse" data-target="#testDetails">Detailed report</button></li>';
        html += '</ul> </header>';
        html += '<div class="collapse" id="testDetails">'; 
            for (var i = 0; i < suite._specs.length; i++) {
                var spec = suite._specs[i];
                html += '<div class="spec">';
                html += specAsHtml(spec);
